...
/// This structure denotes a plugin-specific data returned via the
/// piextPluginGetOpaqueData PI call. Depending on the \c version field, the second \c data
/// field is can be interpreted differently. Versioning and data interpretation is plugin-specific.
struct PluginOpaqueData {
  uintptr_t version;
  void *data;
};
...
__SYCL_EXPORT pi_result piextPluginGetOpaqueData(void *opaque_data_param,
                                                 PluginOpaqueData **opaque_data_return);
