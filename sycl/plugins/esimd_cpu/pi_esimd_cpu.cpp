...
extern "C" inline void invokeLambda_NDITEM_1DIM(void *Wrapper) {
  ...
  // TODO Modulo check like cg_types.hpp
...
extern "C" inline void invokeLambda_NDITEM_2DIM(void *Wrapper) {
  ...
  // TODO Modulo check like cg_types.hpp
  GroupSize[0] = LambdaWrapper->GlobalSize[0] / LambdaWrapper->LocalSize[0];
  GroupSize[1] = LambdaWrapper->GlobalSize[1] / LambdaWrapper->LocalSize[1];
...
extern "C" inline void invokeLambda_NDITEM_3DIM(void *Wrapper) {
  ...
  GroupSize[0] = LambdaWrapper->GlobalSize[0] / LambdaWrapper->LocalSize[0];
  GroupSize[1] = LambdaWrapper->GlobalSize[1] / LambdaWrapper->LocalSize[1];
  GroupSize[2] = LambdaWrapper->GlobalSize[2] / LambdaWrapper->LocalSize[2];
...
pi_result piTearDown(void *PluginParameter) {
  delete reinterpret_cast<sycl::detail::ESIMDEmuPluginOpaqueData *>(PiESimdDeviceAccess->data);
...
pi_result piPluginInit(pi_plugin *PluginInit) {
  ...
  PiESimdDeviceAccess->data = reinterpret_cast<void*>(new sycl::detail::ESIMDDeviceInterface());
